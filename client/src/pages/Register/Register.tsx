...
export default function Register(): JSX.Element {
  ...
  const submitRegHandler = async (values: RegistrationData): Promise<void> => {
    ...
    if (values.photo !== null) {
      formData.append('photo', values.photo as Blob, values.photo.name);
    }

    
    console.log('formData', formData);
    console.log('FormData before submit:', formData.get('photo'));
            ...
            <Box className={styles.regBox} p={6} rounded="md">
              <form className={styles.RegForm} onSubmit={formik.handleSubmit}>
                <VStack p={4} spacing={4} align="flex-start">
                  <FormControl
                    isInvalid={formik.errors.name !== null && formik.errors.name !== undefined}
                  >
                  ...
                  <FormControl
                    isInvalid={formik.errors.email !== null && formik.errors.email !== undefined}
                  >
                  ...
                  <FormControl
                    isInvalid={formik.errors.dateOfBirth !== null && formik.errors.dateOfBirth !== undefined}
                  >
                  ...
                  <FormControl
                    isInvalid={formik.errors.gender !== null && formik.errors.gender !== undefined}
                  >
                ...
                <FormControl
                  isInvalid={formik.errors.photo !== null && formik.errors.photo !== undefined}
                >
